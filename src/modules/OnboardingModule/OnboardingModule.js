...
const OnboardingModule = props => {
    ...
    const styles = StyleSheet.create({
        ...
        Page: {
            flex: 1,
            width: WIDTH,
            borderColor: hextoRGB(theme['--on-surface'], 0.2),
            padding: 16,
        ...
        Button: {
            backgroundColor: theme['--on-primary'],
            color: theme['--primary'],
            borderRadius: 50,
            fontSize: 24
        },
                ...
                <Animated.View 
                    ...
                    style={useAnimatedStyle(() => {
                        return {
                            ...
                            height: 4,
                            backgroundColor: theme[index === scrollIndex.value ? '--on-primary' : '--on-primary'],
                            marginHorizontal: 4
                        }
                    })}/>
            )
    ...
    return (
        <SafeAreaView style={styles.Container}>
            ...
            <Button icon={'chevron-right'} loading={showSpinner} styles={styles.Button} onPress={onNext} size={48} iconSize={32} spinnerColor={theme['--primary']}/>
            </View>
        </SafeAreaView>
    )
}
